---
title: 【笔记】如何正确使用 SourceMap？
date: 2020-10-28 14:27:10
sidebar: 'auto'
tags:
 - 前端工程化
 - 学习笔记
...
![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/42/93/Ciqc1F85_FmAA4UeAABWNiHqsWQ595.png)
...
下面，以[示例代码](https://github.com/fe-efficiency/lessons_fe_efficiency/tree/master/03_develop_environment) 为例，我们来对比下几种常用预设的差异（为了使时间差异更明显，示例中引入了几个大的类库文件）：

![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/43/5E/Ciqc1F87kyiAZvHdAAIGvohk2F4144.png)
...
![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/42/9E/CgqCHl85_KuANSVfAADSE8VO7Qg572.png)

- 源码不包含列信息

![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/42/93/Ciqc1F85_LCAMTlgAADhqpZ4v9o628.png)

- Loader转换后代码

![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/42/9E/CgqCHl85_LqAPrYzAADfmUwS_JE006.png)

- 生成后的产物代码

![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/42/9E/CgqCHl85_MGAHhmMAAKGwvDeXIM418.png)
...
- [create-react-app](https://github.com/facebook/create-react-app/blob/fa648daca1dedd97aec4fa3bae8752c4dcf37e6f/packages/react-scripts/config/webpack.config.js) 中，在生产环境下，根据 shouldUseSourceMap 参数决定使用‘source-map’或 false；在开发环境下使用‘cheap-module-source-map’（不包含列信息的源代码，但更快）。

- [vue-cli-service](https://github.com/vuejs/vue-cli/blob/36f961e43dc76705878659247b563e2af83138ce/packages/%40vue/cli-service/lib/commands/serve.js) 中，与 creat-react-app 中相同。
...
![在这里插入图片描述](https://s0.lgstatic.com/i/image/M00/42/9E/CgqCHl85_N2AUkcpAAEqvMKhgVQ549.png)
